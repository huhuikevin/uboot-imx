...
iomux_v3_cfg_t const usdhc1_pads[] = {
	...
	MX6_PAD_NANDF_D0__SD1_DATA4	| MUX_PAD_CTRL(USDHC1_PAD_CTRL),
	MX6_PAD_NANDF_D1__SD1_DATA5	| MUX_PAD_CTRL(USDHC1_PAD_CTRL),
	MX6_PAD_NANDF_D2__SD1_DATA6	| MUX_PAD_CTRL(USDHC1_PAD_CTRL),
	MX6_PAD_NANDF_D3__SD1_DATA7	| MUX_PAD_CTRL(USDHC1_PAD_CTRL),
};
...
#define USDHC1_EMMC_RST	IMX_GPIO_NR(6, 8)
...
int board_mmc_init(bd_t *bis)
{
	...
	for (i = 0; i < CONFIG_SYS_FSL_USDHC_NUM; i++) {
		...
		case 0:
			...
			/* set eMMC_RST disable */
			gpio_direction_output(USDHC1_EMMC_RST, 1);
...
static void board_pdev_init(void)
{
	/* Setup MU609 */
	imx_iomux_v3_setup_pad(MX6_PAD_GPIO_3__GPIO1_IO03 |
					MUX_PAD_CTRL(EPDC_PAD_CTRL));
	/* Set as output, MU-PWR */
	 ...
	 *   GPS_PWRDWN -- GPIO1_23
	 */
	imx_iomux_v3_setup_pad(MX6_PAD_ENET_REF_CLK__GPIO1_IO23 |
						MUX_PAD_CTRL(EPDC_PAD_CTRL));
	/* Set as output */
	gpio_direction_output(IMX_GPIO_NR(1, 23), 1);
	
	imx_iomux_v3_setup_pad(MX6_PAD_ENET_CRS_DV__GPIO1_IO25 |
						MUX_PAD_CTRL(EPDC_PAD_CTRL));
	/* Set as output */
	gpio_direction_output(IMX_GPIO_NR(1, 25), 1);
	mdelay(50);	/* wait VCC stable */
